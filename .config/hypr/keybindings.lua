...
-- En SUPER+ALT+N (SUPER+SHIFT+N estaba causando efecto de opacidad en la ventana activa).
hl.bind(mainMod .. " + SHIFT + N", hl.dsp.exec_cmd(scriptpath .. "night-toggle.sh"))
